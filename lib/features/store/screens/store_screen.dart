              ...
              SliverToBoxAdapter(child: AnimatedBuilder(
                ...
                builder: (context, child) {
                  if (_tabController!.index == 0) {
                    return Get.find<ProfileController>().modulePermission!.item! ? ItemViewWidget(scrollController: _scrollController, type: storeController.type, onVegFilterTap: (String type) {
